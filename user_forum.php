...
<ul>
  ...
  <li><a href="home.php#location">Location</a></li>
  <li><a href="home.php#ourservices">Our Services</a></li>
...
while($row = mysqli_fetch_assoc($result)){
	...
	echo "<div class = size>Topic : " .$row["topic"]."</div><br>";
...
?>
<form name="forumm" method="POST" action="user_addforum.php" onsubmit = "return forum_validate()">
	<div class = container><center><h2>ADD FORUM</h2></center>
	...
	<div><input type="hidden" name="id" value="<?php echo $login_session;?>"></div><br>
