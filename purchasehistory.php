...
<form action = "storepage.php" method="POST">
	...
	<div id = "tables">
	<p>
	<?php 	$sql = "SELECT orders.orderid, orders.id, orders.total_price,orders.ship_address, orders.ship_postcode,orders.ship_city,orders.ship_state,orders.fullname,orders.phone_no, orders.ship_email, order_item.store_itemid FROM orders INNER JOIN order_item ON orders.orderid = order_item.orderid WHERE id = '$login_session'";
